  ...
  return (
    <div className="bg-gray-100 h-96 flex items-center justify-center mb-12">
      <div className="text-center">
        <p className="text-merqado-orange font-semibold">Tendências 2025</p>
        ...
        <button className="bg-merqado-orange text-white font-bold py-3 px-8 rounded-md hover:bg-merqado-orange-dark transition-colors">
          Compre Agora
        </button>
      </div>
    </div>
